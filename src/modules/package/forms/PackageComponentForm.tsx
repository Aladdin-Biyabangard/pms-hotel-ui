  ...
  const onSubmit = async (data: PackageComponentFormValues) => {
    ...
    try {
      ...
      if (isEditMode && initialData) {
        await packageComponentsApi.update(initialData.id, payload as UpdateRatePackageComponentRequest);
        toast.success('Package component updated successfully');
      } else {
        await packageComponentsApi.create(payload as CreateRatePackageComponentRequest);
