...
import {DollarSign, Hash, Package, Tag} from 'lucide-react';

interface PackageComponentViewProps {
    component: RatePackageComponentResponse | null;
    open: boolean;
    onOpenChange: (open: boolean) => void;
}

export const PackageComponentView: React.FC<PackageComponentViewProps> = ({
    component,
    open,
    onOpenChange,
}) => {
